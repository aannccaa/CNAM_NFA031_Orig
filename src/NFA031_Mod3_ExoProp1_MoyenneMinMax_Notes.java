...
public class NFA031_Mod3_ExoProp1_MoyenneMinMax_Notes {
	public static void main(String[] args) {
		int coefMath = 2, coefInfo = 4, coefFra = 2, nbEleves = 3;
		...
		System.out.format("Moyenne générale de la classe %d eleves = %.2f \n", nbEleves, moyenneGenClasse);
		System.out.format("Moyenne min. de la classe %d eleves = %.2f \n", nbEleves, moyenneMinClasse);
		System.out.format("Moyenne max. de la classe %d eleves = %.2f \n", nbEleves, moyenneMaxClasse);
